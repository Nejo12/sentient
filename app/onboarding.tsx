...
const styles = StyleSheet.create({
  ...
  messageText: { color: colors.ink, fontFamily: fonts.sansSemiBold, fontWeight: '600', fontSize: 24, lineHeight: 30 },
  ...
  finishTitle: { color: colors.ink, fontFamily: fonts.sansSemiBold, fontWeight: '600', fontSize: 22, lineHeight: 28, textAlign: 'center', marginTop: spacing[5] },
