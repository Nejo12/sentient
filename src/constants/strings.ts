...
export const strings = {
  ...
  history: {
    title: 'Your rewrites',
    searchPlaceholder: 'Search your rewrites',
    empty: 'Your rewritten messages will appear here. Copy or use your first reply to build your history.',
    emptySearch: 'No matching rewrites. Try another word or clear the search.',
    perspectivePill: 'Perspective',
    expandHint: 'Tap to view full rewrite',
  ...
  settings: {
    ...
    proTitle: 'Your plan',
    proBody: 'Free — upgrade to Sentient Pro for unlimited guidance when conversations matter.',
    proCta: 'Upgrade',
    proPrice: '€3.99 / month',
    proActiveBody: 'Sentient Pro — unlimited guidance for conversations that matter.',
